class RTAutorizationLocators():
    LOCATOR_RT_AUTHORIZATION_USER = 'username'
    LOCATOR_RT_AUTHORIZATION_PASSWORD = "password"
    LOCATOR_RT_AUTHORIZATION_BUTTON_LOGIN = "kc-login"
    LOCATOR_RT_AUTHORIZATION_BUTTON_REGISTER = "kc-register"
