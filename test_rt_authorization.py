...
class TestValidRegistrationRT:
    ...
    def open(self):
        self.driver = webdriver.Chrome('C:/projects/chromedriver.exe')
...
# 12
    ...
    def test_authorization_invalid_email(self):
        self.driver.find_element(By.ID, RTAutorizationLocators.LOCATOR_RT_AUTHORIZATION_USER).send_keys(
            Invalid_Data.fake_email)
        self.driver.find_element(By.ID, RTAutorizationLocators.LOCATOR_RT_AUTHORIZATION_PASSWORD).send_keys(
            Invalid_Data.fake_password)
        self.driver.find_element(By.ID, RTAutorizationLocators.LOCATOR_RT_AUTHORIZATION_BUTTON_LOGIN).click()
...
# 13
    ...
    def test_authorization_invalid_phoneNumber(self):
        self.driver.find_element(By.ID, RTAutorizationLocators.LOCATOR_RT_AUTHORIZATION_USER).send_keys(
...
# 15
    ...
    def test_authorization_xss_in_login(self):
        self.driver.find_element(By.ID, RTAutorizationLocators.LOCATOR_RT_AUTHORIZATION_USER).send_keys(
            Invalid_Data.xss)
        self.driver.find_element(By.ID, RTAutorizationLocators.LOCATOR_RT_AUTHORIZATION_PASSWORD).send_keys(
            Invalid_Data.fake_password)
